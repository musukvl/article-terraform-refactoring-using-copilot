...
However, the Terraform development expirence is still close to what we had for JavaScript in 2008: we have syntax highlighting, basic static analysis, and basic code navigation. 
